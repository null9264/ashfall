...
export function sha256(input: string): string {
  ...
  const K = [
    0x428a2f98, 0x71374491, 0xb5c0fbcf, 0xe9b5bda1, 0x3956c25b, 0x59f111f1, 0x923f82a4, 0xab1c5ed5,
  ...
  const bitLen = l * 8;
  // length as 64-bit big-endian (only lower 32-bit needed in practice)
  bytes.push(0, 0, 0, 0);
  ...
  for (let chunk = 0; chunk < bytes.length; chunk += 64) {
    const W: number[] = [];
    for (let i = 0; i < 16; i++) {
      W.push((bytes[chunk + i * 4] << 24) | (bytes[chunk + i * 4 + 1] << 16) | (bytes[chunk + i * 4 + 2] << 8) | bytes[chunk + i * 4 + 3]);
    }
    for (let i = 16; i < 64; i++) {
